...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    public VentanaPrincipal() {
        ...
        this.menu.addActionListener(cVentanaPrincipal);
        this.btnProfesor.addActionListener(cVentanaPrincipal);
        this.jMenuEjemplo.addActionListener(cVentanaPrincipal);
    ...
    private void initComponents() {
        ...
        btnProfesor = new javax.swing.JMenuItem();
        jMenu6 = new javax.swing.JMenu();
        jMenuEjemplo = new javax.swing.JMenuItem();
        ...
        menu.setText("Profesores");

        btnProfesor.setText("Registrar Profesor");
        menu.add(btnProfesor);

        menuEstudiante.add(menu);

        jMenu6.setText("Ejemplo");

        jMenuEjemplo.setText("Ventana ejemplo");
        jMenuEjemplo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuEjemploActionPerformed(evt);
            }
        });
        jMenu6.add(jMenuEjemplo);

        menuEstudiante.add(jMenu6);
    ...
    private void jMenuEjemploActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuEjemploActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jMenuEjemploActionPerformed
    ...
    private javax.swing.JMenuItem btnProfesor;
    ...
    private javax.swing.JMenuItem jMenuEjemplo;
