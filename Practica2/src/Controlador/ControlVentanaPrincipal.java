...
public class ControlVentanaPrincipal implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
       ...
       if(e.getActionCommand().equalsIgnoreCase("Mantener Curso")){
        ...
        if(e.getActionCommand().equalsIgnoreCase("Registrar Profesor")){
            this.ventanaProfesor = new VentanaProfesor(Dbprofesor);
            ventanaProfesor.setVisible(true);
        }
        if(e.getActionCommand().equalsIgnoreCase("Ventana ejemplo")){
